...
#' Quick Data Read CSV
#'
#' A simple wrapper function for \code{read.csv(file =..., header = TRUE, stringsAsFactors = FALSE)}
#'
...
qdr <- function(pth) {
  read.csv(file = pth, header = TRUE, stringsAsFactors = FALSE)
}
